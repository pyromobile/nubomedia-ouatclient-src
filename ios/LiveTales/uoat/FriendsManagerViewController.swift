...
class FriendsManagerViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, AddFriendDelegate, NotificationAcceptedDelegate, FriendsListDelegate
{
    ...
    required init?(coder aDecoder: NSCoder)
    {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(FriendsManagerViewController.networkStatusChanged(_:)), name: NetworkWatcher.reachabilityStatusChangedNotification, object: nil)
    }
    ...
    {
        print("FriendsManagerViewController::networkStatusChanged was called...")
