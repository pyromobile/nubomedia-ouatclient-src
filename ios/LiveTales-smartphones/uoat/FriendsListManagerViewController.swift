...
class FriendsListManagerViewController: UIViewController, UITableViewDataSource, UITableViewDelegate
{
    ...
    required init?(coder aDecoder: NSCoder)
    {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(FriendsListManagerViewController.networkStatusChanged(_:)), name: NetworkWatcher.reachabilityStatusChangedNotification, object: nil)
    }
    ...
    */
    ...
    {
        print("FriendsListManagerViewController::networkStatusChanged was called...")
