...
class TaleModeViewController: UIViewController, UIGestureRecognizerDelegate, Observable, RoomReadyDelegate
{
    weak var user:User!
    ...
    */
    ...
    private let FontSizeMax:Int = 32
