...
protocol OptionsEndTaleDelegate:class
{
    func onExit()
    func onRepeatTale()
...
class OptionsEndTaleViewController: UIViewController, LibraryDelegate
{
    weak var delegate:OptionsEndTaleDelegate?
    ...
    */
    ...
    {
        delegate?.onChooseOtherTale( bookId )
    }
